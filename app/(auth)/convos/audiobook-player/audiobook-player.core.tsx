...
function MiniDictionary({
  ...
  return (
    <div className="w-full sm:w-96 bg-gray-50 dark:bg-[rgb(13,14,15)] rounded p-4 sm:p-8 sm:mt-20 mt-0">
      ...
      {isMeaningDiscoveryLoading ? (
        ...
        <>
          <p className="text-gray-400 font-light">{data?.en}</p>

          <p className="text-sm mt-4 dark:text-gray-300 text-gray-700">
