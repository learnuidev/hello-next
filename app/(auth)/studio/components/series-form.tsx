...
import { StepsEnum } from "../create-series/types";
import { StepTitle } from "../create-series/components/step-title";
import { StepDescription } from "../create-series/components/step-description";
import { StepTopicType } from "../create-series/components/step-topic-type";
import { StepSourceSelection } from "../create-series/components/step-source-selection";
import { StepPhotoUpload } from "../create-series/components/step-photo-upload";
import { StepSummary } from "../create-series/components/step-summary";
import { seriesSchema } from "../create-series/validation";
...
export function SeriesForm({
  ...
  const [seriesData, setSeriesData] = useState<SeriesFormData>({
    ...
    topicType: initialData?.topicType || "",
    sourceId: initialData?.sourceId || "",
    sourceName: initialData?.sourceName || "",
    photoAssetId: initialData?.photoAssetId || "",
