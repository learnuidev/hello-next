...
export const Icons = {
  ...
  circleArrowUp: createFAIcon(faCircleArrowUp),
  arrowDown: createFAIcon(faArrowDown),
  arrowUp: createFAIcon(faArrowUp),
  ...
  volumeSolid: createFAIcon(faVolumeSolid),
