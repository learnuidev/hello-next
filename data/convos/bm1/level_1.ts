  ...
  learnings: [
    {
      ...
      values: [{ title: "Exchanging Greetings ", hanzi: "你好" }],
    },
    {
      title: "Goals",
      sortOrder: 2,
      ...
      values: [
        { title: "Exchange basic greetings", hanzi: "你好", phraseIds: [] },
        {
    ...
    },
    {
      ...
      values: [
        { title: "The verb 是 (shì)", hanzi: "是" },
        { title: "The adverb 很 (hěn)", hanzi: "很" },
        { title: "The verb 会 (huì)", hanzi: "会" },
        { title: "Possessive particle 的 (de)", hanzi: "的" },
        { title: "The Adverbial Modifier 得 (de)", hanzi: "得" },
        { title: "The verb 叫 (jiào)", hanzi: "叫" },
        { title: "Questions ending with 吗 (ma)", hanzi: "吗" },
        { title: "Questions ending with 呢 (ne)", hanzi: "呢" },
        { title: "The adverb 也 (yě)", hanzi: "也" },
      ],
    },
    {
      sortOrder: 4,
